...
import { Columns, Heading, <Button></Button> } from 'react-bulma-components';
...
const HomeScreen = () => {
    return (
        <SectionWrapper>
            <Columns>
                <Columns.Column>
                    <MainHeading className='has-text-weight-light has-text-centred has-text-white' size={1}>
                        SEU APP DE <br /><span className='has-text-success'>MÚSICA</span>
                    </MainHeading>
                </Columns.Column>
            </Columns>
            <Columns className="is-created is-mobile">
            ...
            <Columns className="has-text-centred">
                <Columns.Column>
